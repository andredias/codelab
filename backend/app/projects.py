...
async def save_project(
    project: CodelabProject, ttl: int | None = None, key: str = 'project:{}'
) -> None:
    """
...
def calc_id(proj: ProjectToRun) -> str:
    ...
    return md5(text.encode()).hexdigest()  # nosec B324


def codelab_to_codebox_project(project: ProjectToRun) -> CodeboxProject:
    language_mappings = {
        'python': {'filename': 'main.py', 'command': '/usr/local/bin/python main.py'},
    }
